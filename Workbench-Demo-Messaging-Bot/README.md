...
## Visual Studio
- Open Workbench_Demo_Messaging_Bot.csproj in Visual Studio.
...
- File -> Open bot and open [Workbench_Demo_Messaging_Bot.bot](Workbench_Demo_Messaging_Bot.bot).
